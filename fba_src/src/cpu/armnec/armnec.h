...
struct ArmNec
{
	...
	unsigned char (*read8  )(unsigned int a);			// [r7,#0x40]
	unsigned int (*read16 )(unsigned int a);			// [r7,#0x44]
	void (*write8 )(unsigned int a,unsigned char d);		// [r7,#0x48]
	void (*write16)(unsigned int a,unsigned int d);		// [r7,#0x4C]
	unsigned char (*in8 )(unsigned int a);				// [r7,#0x50]
	void (*out8)(unsigned int a, unsigned char d);		// [r7,#0x54]
